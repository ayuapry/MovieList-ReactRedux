            ...
            <Swiper pagination={{ dynamicBullets: true, }} modules={[Pagination]} className="mySwiper w-full h-[750px]">
                ...
                <SwiperSlide>
                  ...
                  <div className='absolute w-full top-[20%] p-4 md:p-8 '>
                    ...
                    <p className='w-full md:max-w-[70%] lg:max-w-[50%] xl:max-w-[35%] text-gray-200'> {truncateString(movie1?.overview,200)}</p>
                    <div className='my-4'>
                        <button className=' bg-red-600 rounded-full text-white hover:bg-red-400 hidden md:flex pl-5 py-3 mr-4 w-[170px]'>
                        <AiOutlinePlayCircle size={25} className='mr-2' />Watch Trailer 
                        </button>
                ...
                <SwiperSlide>
                  ...
                  <div className='absolute w-full top-[20%] p-4 md:p-8 '>
                    ...
                    <p className='w-full md:max-w-[70%] lg:max-w-[50%] xl:max-w-[35%] text-gray-200'> {truncateString(movie2?.overview,200)}</p>
                    <div className='my-4'>
                        <button className=' bg-red-600 rounded-full text-white hover:bg-red-400 hidden md:flex pl-5 py-3 mr-4 w-[170px]'>
                        <AiOutlinePlayCircle size={25} className='mr-2' />Watch Trailer 
                        </button>
